...
Данное руководство содержит общие сведения и инструкции по эксплуатации программного обеспечения (*[ПО](#glossary_1)*) для обработки астрономических изображений галактик со сложной спиральной структурой - ***"Детектор прямых спиральных руковов"***.
...
- [Главное окно программы.](#main_win)
  ...
  - [Окно предпросмотра.](#preview_img)
...
## <a name="preview_img">Окно предпросмотра</a>

![PreviewImg](imgRU/5_preview_img.PNG "Окно предпросмотра")
...
![ZhangSuenMultProc](imgRU/8_mult_proc.PNG "Окно множественной обработки методом Зонга-Суня")
...
![ZhangSuenMultProcExec](imgRU/9_mult_proc_exec.PNG "Процесс обработки нескольких изображений")
